...
| 管理端 0.1.18 · Windows x64 | 部署到 Windows Server 或长期运行的 Windows 主机，提供管理与玩家下载服务 | [下载 ZIP](https://github.com/hanhanyu666/DreamingFish-Updater/releases/latest/download/dfs-admin-windows-x64-0.1.18.zip) |
